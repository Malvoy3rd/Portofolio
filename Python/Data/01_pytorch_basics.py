...
Original file is located at
    https://colab.research.google.com/drive/1OkRnRAnaORTdL1_yW7HsjAhHoSngRW5h
"""
...
"""## Typenya harus float, soalnya biasanya dalam perhitungan nanti pasti hasilnya desimal."""
...
t6 =  torch.full((3,2),41)
t6

t7=torch.cat((t3,t6)) #join some tensors
t7
...
terus kenapa harus pake Pytorch ?
1. Autograd : otomatis komputasi gradien untuk operasi tensor (utk deep learning).
2. GPU Support : Penggunaan GPU lebih effisien.
